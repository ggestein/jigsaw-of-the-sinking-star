...
static func create_all_level_configs() -> Array[LevelConfigEntry]:
	...
	level_config.pads = []
	level_theme_config = LevelTheme.LevelThemeConfig.new()
	level_theme_config.bg_packed_scene_path = AssetPathConfig.background_packedscene_path(2)
	...
	level_theme_config = LevelTheme.LevelThemeConfig.new()
	level_theme_config.bg_packed_scene_path = AssetPathConfig.background_packedscene_path(3)
	config_entry = LevelConfigEntry.new()
	...
	level_config.doors.append(door_config)
	level_theme_config = LevelTheme.LevelThemeConfig.new()
	level_theme_config.bg_packed_scene_path = AssetPathConfig.background_packedscene_path(4)
	config_entry = LevelConfigEntry.new()
	...
	level_config.pads = []
	level_theme_config = LevelTheme.LevelThemeConfig.new()
	level_theme_config.bg_packed_scene_path = AssetPathConfig.background_packedscene_path(5)
	config_entry = LevelConfigEntry.new()
	...
	level_config.doors.append(door_config)
	level_theme_config = LevelTheme.LevelThemeConfig.new()
	level_theme_config.bg_packed_scene_path = AssetPathConfig.background_packedscene_path(6)
	level_theme_config.box_packed_scene_path[1] = AssetPathConfig.box_blue_packedscene_path()
	level_theme_config.box_packed_scene_path[2] = AssetPathConfig.box_yellow_packedscene_path()
	level_theme_config.box_packed_scene_path[3] = AssetPathConfig.box_green_packedscene_path()
	level_theme_config.box_packed_scene_path[4] = AssetPathConfig.box_red_packedscene_path()
	...
	level_config.range = Rect2i(0, 0, 7, 7)
	level_config.goals = [
		Vector2i(0, 1),
		Vector2i(0, 4),
	]
	...
	char_config = CoreLevelConfig.CharacterConfig.new()
	char_config.inst_cls = CoreGameplay.CharacterClass.WARRIOR
	char_config.inst_pos = Vector2i(2, 4)
	char_config.inst_face = 1
	level_config.characters.append(char_config)
	char_config = CoreLevelConfig.CharacterConfig.new()
	char_config.inst_cls = CoreGameplay.CharacterClass.MAGE
	char_config.inst_pos = Vector2i(2, 2)
	char_config.inst_face = 1
	level_config.characters.append(char_config)
	level_config.boxes = [
		Vector2i(0, 2),
	...
	door_config = CoreLevelConfig.DoorConfig.new();
	door_config.position = Vector2i(5, 3)
	...
	level_config.range = Rect2i(0, 0, 10, 7)
	level_config.goals = [
		Vector2i(6, 0),
		Vector2i(6, 6),
	]
	...
	char_config = CoreLevelConfig.CharacterConfig.new()
	char_config.inst_cls = CoreGameplay.CharacterClass.WARRIOR
	char_config.inst_pos = Vector2i(1, 5)
	char_config.inst_face = 1
	level_config.characters.append(char_config)
	char_config = CoreLevelConfig.CharacterConfig.new()
	char_config.inst_cls = CoreGameplay.CharacterClass.THIEF
	...
	door_config = CoreLevelConfig.DoorConfig.new();
	door_config.position = Vector2i(8, 1)
	door_config.need_pads_indices = [0, 1]
	level_config.doors.append(door_config)
	door_config = CoreLevelConfig.DoorConfig.new();
	door_config.position = Vector2i(8, 5)
	door_config.need_pads_indices = [0, 1]
	level_config.doors.append(door_config)
	level_theme_config = LevelTheme.LevelThemeConfig.new()
	config_entry = LevelConfigEntry.new()
	...
	char_config = CoreLevelConfig.CharacterConfig.new()
	char_config.inst_cls = CoreGameplay.CharacterClass.MAGE
	char_config.inst_pos = Vector2i(4, 6)
	char_config.inst_face = 1
	level_config.characters.append(char_config)
	char_config = CoreLevelConfig.CharacterConfig.new()
	char_config.inst_cls = CoreGameplay.CharacterClass.THIEF
	char_config.inst_pos = Vector2i(3, 3)
	char_config.inst_face = 1
	level_config.characters.append(char_config)
	level_config.boxes = [
		Vector2i(8, 6),
	...
	door_config = CoreLevelConfig.DoorConfig.new();
	door_config.position = Vector2i(2, 3)
	door_config.need_pads_indices = [0, 1]
	level_config.doors.append(door_config)
	level_theme_config = LevelTheme.LevelThemeConfig.new()
	config_entry = LevelConfigEntry.new()
	...
	char_config = CoreLevelConfig.CharacterConfig.new()
	char_config.inst_cls = CoreGameplay.CharacterClass.WARRIOR
	char_config.inst_pos = Vector2i(5, 2)
	char_config.inst_face = 2
	level_config.characters.append(char_config)
	char_config = CoreLevelConfig.CharacterConfig.new()
	char_config.inst_cls = CoreGameplay.CharacterClass.MAGE
	char_config.inst_pos = Vector2i(5, 0)
	...
	door_config = CoreLevelConfig.DoorConfig.new();
	door_config.position = Vector2i(7, 1)
	door_config.need_pads_indices = [0]
	level_config.doors.append(door_config)
	level_theme_config = LevelTheme.LevelThemeConfig.new()
	config_entry = LevelConfigEntry.new()
	...
	level_config.range = Rect2i(0, 0, 9, 5)
	level_config.goals = [
		Vector2i(2, 2),
		Vector2i(3, 4),
		Vector2i(4, 4),
	...
	char_config = CoreLevelConfig.CharacterConfig.new()
	char_config.inst_cls = CoreGameplay.CharacterClass.WARRIOR
	char_config.inst_pos = Vector2i(8, 0)
	char_config.inst_face = 0
	level_config.characters.append(char_config)
	char_config = CoreLevelConfig.CharacterConfig.new()
	char_config.inst_cls = CoreGameplay.CharacterClass.THIEF
	char_config.inst_pos = Vector2i(0, 0)
	char_config.inst_face = 0
	level_config.characters.append(char_config)
	char_config = CoreLevelConfig.CharacterConfig.new()
	char_config.inst_cls = CoreGameplay.CharacterClass.MAGE
	char_config.inst_pos = Vector2i(2, 0)
	char_config.inst_face = 0
	level_config.characters.append(char_config)
	level_config.boxes = [
		Vector2i(6, 0),
	...
	door_config = CoreLevelConfig.DoorConfig.new();
	door_config.position = Vector2i(0, 2)
	door_config.need_pads_indices = [0, 1]
	level_config.doors.append(door_config)
	door_config = CoreLevelConfig.DoorConfig.new();
	door_config.position = Vector2i(8, 2)
	door_config.need_pads_indices = [0, 1]
	level_config.doors.append(door_config)
	level_theme_config = LevelTheme.LevelThemeConfig.new()
	config_entry = LevelConfigEntry.new()
